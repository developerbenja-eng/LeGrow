  ...
  return (
    <main className="min-h-screen bg-gray-950 text-gray-100">
      <div className="max-w-6xl mx-auto px-6 py-12">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-green-400 mb-2">LeGrow</h1>
          ...
          <div className="mt-4 flex gap-4">
            ...
            <a href="https://github.com/developerbenja-eng/LeGrow" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-sm font-medium transition-colors">
              GitHub
            </a>
          </div>
        </div>
